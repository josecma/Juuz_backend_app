...
//   constructor(
//     // @Inject(POINT_CACHE) private cacheManager: Cache
//   ) { }
...
//   //     const keys = await this.cacheManager.stores.keys(); // Esto es un ejemplo, puede que necesites implementar tu propia lógica para obtener las claves
