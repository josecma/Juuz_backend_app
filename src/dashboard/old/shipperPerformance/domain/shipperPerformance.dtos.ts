...
// import { ShipperPerformance } from '@prisma/client';
// import {
//   IsInt,
//   IsNotEmpty,
//   IsOptional,
...
// type ShipperPerformanceWithoutId = Omit<
//   ShipperPerformance,
//   | 'id'
//   | 'createdAt'
//   | 'updatedAt'
...
//   | 'userId'
// >;
// export class ShipperPerformanceDto implements ShipperPerformanceWithoutId {
//   @IsNotEmpty()
...
//   @IsNotEmpty()
//   @ApiProperty({ description: 'Instruction Clarity rating (1-5)' })
...
//   @IsNotEmpty()
//   @ApiProperty({ description: 'Accessibility rating (1-5)' })
...
//   @IsNotEmpty()
//   @ApiProperty({ description: 'On TimePayment rating (1-5)' })
//   @IsInt({ message: 'Friendliness must be an integer' })
//   @Min(1, { message: 'Friendliness must be at least 1' })
//   @Max(5, { message: 'Friendliness must be at most 5' })
...
// export class UpdateShipperPerformanceDto extends PartialType(
