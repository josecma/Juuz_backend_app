...
@Injectable({})
export default class FindOneOrderByIdUseCas {
    ...
    public async execute(
        ...
        try {
            ...
            if (!id) {
                ...
                throw new Error(`${FindOneOrderByIdUseCas.name}Err: params.id is required.`);
            ...
            if (!order) {
                ...
                throw new NotFoundException(`${FindOneOrderByIdUseCas.name}Err: order with id:${id} does not exist.`);
